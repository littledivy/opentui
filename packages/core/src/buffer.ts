...
export class OptimizedBuffer {
  ...
  get buffers(): {
    ...
    if (this._rawBuffers === null) {
      ...
      this._rawBuffers = {
        char: new Uint32Array(Deno.UnsafePointerView.getArrayBuffer(charPtr, size * 4)),
        fg: new Float32Array(Deno.UnsafePointerView.getArrayBuffer(fgPtr, size * 4 * 4)),
        bg: new Float32Array(Deno.UnsafePointerView.getArrayBuffer(bgPtr, size * 4 * 4)),
        attributes: new Uint32Array(Deno.UnsafePointerView.getArrayBuffer(attributesPtr, size * 4)),
      }
    }
  ...
  public drawGrayscaleBuffer(
    ...
    this.guard()
    this.lib.bufferDrawGrayscaleBuffer(this.bufferPtr, posX, posY, Deno.UnsafePointer.of(intensities)!, srcWidth, srcHeight, fg, bg)
  }
  ...
  public drawGrayscaleBufferSupersampled(
    ...
    this.lib.bufferDrawGrayscaleBufferSupersampled(
      ...
      posX,
      posY,
      Deno.UnsafePointer.of(intensities)!,
      srcWidth,
      srcHeight,
      fg,
      bg,
